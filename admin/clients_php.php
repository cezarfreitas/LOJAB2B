    ...
    switch ($action) {
        ...
        case 'toggle_status':
            try {
                ...
                logActivity($_SESSION['user_id'], 'client_status_changed', "Cliente {$statusText}: {$currentClient['razao_social']} (ID: $id)");
